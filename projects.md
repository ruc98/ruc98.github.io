...
- Competed in a Kaggle Contest (Ranked 5th) to predict User-based Movie Ratings using Machine Learning.
- Implemented Ensembles of Neighborhood model, Latent Factor model and other ML Regressors.
